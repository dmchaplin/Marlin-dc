...
#define CONFIG_EXAMPLES_DIR "config/default" // <dc>
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        20 // Seconds <dc> 20
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                60 // Seconds  <dc>
 ...
 */
//#define FAN_MIN_PWM 50  <dc> disabled
...
//#define QUICK_HOME   <dc>                       // If G28 contains XY do a diagonal move first
 ...
 */
//#define ADAPTIVE_STEP_SMOOTHING  <dc>
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // <dc>enable Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -4.0  // <dc> enable

    // Set a convenient position to do the calibration (probing point and nozzle/bed-distance)
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER }  // <dc> enable
  #endif
#endif
  ...
  #define LCD_INFO_MENU  // <dc> enable
  ...
  #define PREHEAT_SHORTCUT_MENU_ITEM  // <dc> enable

#endif // HAS_MARLINUI_MENU

#if ANY(HAS_DISPLAY, DWIN_LCD_PROUI, DWIN_CREALITY_LCD_JYERSUI)
  #define SOUND_MENU_ITEM   // <dc> enable Add a mute option to the LCD menu
...
#define SET_PROGRESS_MANUALLY   // <dc>
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SHOW_REMAINING_TIME           // <dc> Display estimated time to completion (prefix 'R')
  ...
  //#define SCROLL_LONG_FILENAMES     <dc>    // Scroll long filenames in the SD card menu
 ...
 */
//#define NO_SD_HOST_DRIVE  <dc> // Disable SD Card access over USB (for security).
 ...
 */
#define ADVANCED_PAUSE_FEATURE  // <dc> 
  ...
  #define FILAMENT_LOAD_UNLOAD_GCODES           // <dc> Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
   ...
   */
  //#define SQUARE_WAVE_STEPPING  <dc>
...
#define HOST_ACTION_COMMANDS
  ...
  #define HOST_PAUSE_M76                // <dc> Tell the host to pause in response to M76
  //#define HOST_PROMPT_SUPPORT           // <dc> Initiate host prompts to get user feedback
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS   // <dc> Send some status messages to the host as notifications
  #endif
  #define HOST_START_MENU_ITEM          // <dc> Add a menu item that tells the host to start
  #define HOST_SHUTDOWN_MENU_ITEM       // <dc> Add a menu item that tells the host to shut down
#endif
